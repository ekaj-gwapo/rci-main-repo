...
export default function EntryBatchManagement() {
      ...
      <div className="bg-white border-b border-emerald-100 sticky top-0 z-40">
        <div className="w-full px-6 py-4 flex justify-between items-center">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-2xl font-bold text-emerald-900">Printed Batches (Read-Only)</h1>
              <p className="text-sm text-gray-600">{user?.email}</p>
            </div>
          </div>
          <div className="flex gap-2">
            <Button
              onClick={() => router.push('/entry-dashboard')}
              variant="outline"
          ...
          <>
            <div className="mb-6">
              <h2 className="text-xl font-semibold text-gray-900 mb-2">
                Your Printed Transaction Batches
              </h2>
              <p className="text-sm text-gray-600">
                View transactions that have been printed and batched by the Viewer user.
              </p>
            </div>
            <BatchList
              key={refreshKey}
